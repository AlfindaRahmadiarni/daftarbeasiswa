...
<style type="text/css">
  ...
  <div class="isi"><br><br>
        <!-- <hr><h3 align="center">Maaf, Anda Tidak Berhasil Mendapatkan Beasiswa ini</h3><hr> -->
        <?php $id = $this->session->userdata('id'); ?>
        <hr><h3 align="center">Maaf, Peserta dengan ID Daftar <b><?php echo $id; ?></b> dan NIM <b><?php echo $username; ?></b> Belum Berhasil Mendapatkan Beasiswa ini</h3><hr>
  </div>
  <footer>
    <div class="footer">
      <div class="container">
