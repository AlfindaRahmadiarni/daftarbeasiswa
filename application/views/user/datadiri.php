            ...
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                ...
                <?php if($this->session->userdata('logged_in')) : ?>
                      <li role="presentation"><a href="<?php echo site_url().'Daftar/datadiri/' ?>" class="active">Data Diri</a></li>
                  <?php endif; ?> 
...
<?php endif; ?>
  ...
  <div class="isi"><br><br>
    ...
    <div class="col-md-4">
     <br><h2 align="center"><b>Data Diri</b></h2><br><br>

     <hr>
     <h3><b>A. Data Pribadi</b></h3>
     <hr><br>
      <table>
        <tr>
          <div align="center">
          <img src="<?php echo base_url() .'uploads/'. $datadiri->foto ?>" width='250' height='300'>
        </div><br>
        </tr>
        <tr>
        ...
        <tr>
          <td><h4>Jurusan</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->jurusan; ?></h4></td>
        </tr>
        <tr>
          <td><h4>Jenis Kelamin</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->jk; ?></h4></td>
        </tr>
        <tr>
          <td><h4>TTL</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->tempatLahir.", ".tgl_indo($datadiri->tglLahir); ?></h4></td>
        </tr>
        <tr>
          <td><h4>Alamat Lengkap</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->alamatLengkap; ?></h4></td>
        </tr>
        <tr>
          <td><h4>No Telp</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->telp; ?></h4></td>
        </tr>
        <tr>
          <td><h4>Tanggal Daftar</h4></td>
          <td>:</td>
          <td><h4>
            <?php $tgl=character_limiter($datadiri->tglDaftar, 10) ?>
            <?php echo tgl_indo($tgl); ?></h4>
            </td>
        </tr>
        <tr>
      ...
      <br><hr>
      <h3><b>B. Data Prestasi</b></h3>
      <hr>
      <table> -->
        <tr>
          <td width="180px"><h4>IPK Terakhir</h4></td>
          <td width="50px">:</td>
          <td><h4><?php echo $datadiri->ipk; ?></h4></td>
        </tr>
        <!-- <tr>
      ...
      <br><hr>
      <h3><b>B. Data Tambahan</b></h3>
      <hr>
      <table>
        <tr>
          <td width="180px"><h4>Nama Ayah</h4></td>
          <td width="50px">:</td>
          <td><h4><?php echo $datadiri->namaAyah; ?></h4></td>
        </tr>
        <tr>
          <td><h4>Nama Ibu</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->namaIbu; ?></h4></td>
        </tr>
        <tr>
          <td><h4>Alasan Pengajuan Beasiswa</h4></td>
          <td>:</td>
          <td><h4><?php echo $datadiri->alasanBeasiswa; ?></h4></td>
        </tr>
      </table>
      ...
      <a href="<?php echo site_url('Daftar/edit/') ?>" class="btn btn-primary">Edit Data Diri </a> 
      <hr>
      <?php } ?>
<br><br>
    </div>
