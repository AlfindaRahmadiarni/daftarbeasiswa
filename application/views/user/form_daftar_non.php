		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					...
					<?php echo form_open_multipart( 'Daftar/create2', array('class' => 'needs-validation', 'novalidate' => '') ); ?>
					...
					<div class="form-group">
						<label for="ipk">Tingkat Internasional</label>
						<input type="text" class="form-control" name="internasional" placeholder="0" value="<?php echo set_value('internasional') ?>">
					</div>
					<div class="form-group">
						<label for="ipk">Tingkat Nasional</label>
						<input type="text" class="form-control" name="nasional" placeholder="0" value="<?php echo set_value('nasional') ?>">
					</div>
					<div class="form-group">
						<label for="ipk">Tingkat Provinsi</label>
						<input type="text" class="form-control" name="provinsi" placeholder="0" value="<?php echo set_value('provinsi') ?>">
					</div>
					<div class="form-group">
						<label for="ipk">Tingkat Kota</label>
						<input type="text" class="form-control" name="kota" placeholder="0" value="<?php echo set_value('kota') ?>">
					</div>	
