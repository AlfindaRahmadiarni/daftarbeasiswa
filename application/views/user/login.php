          ...
          <div class="navbar-collapse collapse">              
            <div class="menu">
              ...
              <ul class="nav nav-tabs" role="tablist">
                ...
                <?php if(!$this->session->userdata('logged_in')) : ?>
                <li role="presentation"><a href="<?php echo site_url().'User/login/' ?>" class="active">Login</a></li>
                <?php endif; ?>      
              </ul>
            </div>
          </div>            
...
<div>
  ...
  <div class="isi"><br><br>
    ...
    <div class="col-md-4">
     <br><h3 align="center"><b>FORM LOGIN</b></h3><br><br>
        <div class="form-group">
          ...
          <button type="submit" class="btn btn-secondary"><a href="<?php echo site_url().'User/' ?>">Cancel</a></button><br><br><br>
      </div>
    </div>
  </div>
</div>
