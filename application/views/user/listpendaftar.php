...
<div class="tes" align="center"><a href="<?php echo site_url('User/pendaftar/') ?>" class="btn btn-warning">Grid</a>
<a href="<?php echo site_url('User/listpendaftar/') ?>" class="btn btn-success">List</a></div>

	
<div id="listpendaftar" class=" table-responsive">
	<div class="container">
		<div class="row"> 
			<h4 align="center" style="color:#1BBD36"><b>LIST PENDAFTAR</b></h4><br>
